...
str(unitdiscount)
num [1:12] 0.5 0.5 0.5 0.5 0.5 0.5 0.5 0.67 0.83 1 1 
...
# add variable that is the sum of allocated units less the ETS liability
...
# add up Overallocation values and ERU into Stockpile variable
...
lines(NZsteelunits[["Year"]][1:11],NZsteelunits[["Emissions"]][1:11]/10^6,col="#1B9E77",lwd=1)
points(NZsteelunits[["Year"]][1:11],NZsteelunits[["Emissions"]][1:11]/10^6,cex=1,pch=16, col="#1B9E77")
legend(2011, 1.2, bty = "n",cex=1.1, "Steel emissions MfE Greenhouse Gas Inventory 2020",col = "#1B9E77", text.col = 1,lty = 1, pch=16 ) 
...
mtext(side=1,line=-1.25,cex=1,"Data: New Zealand’s Greenhouse Gas Inventory 1990 – 2020, EPA Industrial Allocations")
mtext(side=2,cex=1, line=-1.2,expression(paste("million tonnes C", O[2], "-e")))
mtext(side=4,cex=0.75, line=0.05,R.version.string)
box()
dev.off() 
...
mtext(side=1,line=-1.25,cex=1,"Data: New Zealand’s Greenhouse Gas Inventory 1990 2020, EPA Industrial Allocations 2021")
mtext(side=2,cex=1, line=-1.2,expression(paste("million tonnes C", O[2], "-e")))
mtext(side=4,cex=0.75, line=0.05,R.version.string)
box()
dev.off()
...
mtext(side=1,line=-1.25,cex=1,"Data: NZ Greenhouse Gas Inventory 2020, EPA Industrial Allocations 2021")
mtext(side=2,cex=1, line=-1.2,expression(paste("million tonnes C", O[2], "-e")))
mtext(side=4,cex=0.75, line=0.05,R.version.string)
box()
dev.off()

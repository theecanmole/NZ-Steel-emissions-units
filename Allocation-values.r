...
png("NZsteel-units-marketvalue-560by420.png", bg="white", width=560, height=420,pointsize = 12)
...
mtext(side=3,cex=1, line=-0.4,expression(paste("The emission units allocated to NZ Steel have market value of $308 million")) )
dev.off() 
